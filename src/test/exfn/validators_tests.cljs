(ns exfn.validators-tests
  (:require [cljs.test :refer-macros [deftest is testing run-tests]]
            [exfn.validators :refer [first-argument-is-a-register?
                                     has-no-arguments?
                                     has-one-argument?
                                     has-two-arguments?
...
(deftest one-argument-and-its-a-label-tests
  ...
  (testing "instruction has no arguments, should return error"
    (is (= "expects one argument and it must be a label. Labels can not start with a digit." (one-argument-and-its-a-label "jmp"))))
  (testing "instruction has two arguments, should return error"
    (is (= "expects one argument and it must be a label. Labels can not start with a digit." (one-argument-and-its-a-label "jmp foo :bar"))))
  (testing "instruction has one argument that is a number, should return error"
    (is (= "expects one argument and it must be a label. Labels can not start with a digit." (one-argument-and-its-a-label "jmp 5"))))
  (testing "instruction has one argument that is a register should return error"
    (is (= "expects one argument and it must be a label. Labels can not start with a digit." (one-argument-and-its-a-label "jmp :x")))))
